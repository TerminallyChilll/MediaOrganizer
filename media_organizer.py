    ...
    try:
        ...
        for show, c in flat_changes:
            ...
            try:
                ...
                if os.name == 'nt' and str(old_p).lower() == str(new_p).lower() and str(old_p) != str(new_p):
                    temp = str(old_p) + '_temp'
...
def run_renamer(movies_path=None, tv_path=None, excel_path=None):
    try:
        if not excel_path:
        ...
        try:
            ...
            df_movies = pd.read_excel(excel_path, sheet_name='Movies') if has_movies else None
            df_tv = pd.read_excel(excel_path, sheet_name='TV Shows') if has_tv else None
    ...
    for i, c in enumerate(tqdm(changes_sorted)):
        ...
        try:
            ...
            if os.name == 'nt' and str(old_p).lower() == str(new_p).lower() and str(old_p) != str(new_p):
                temp_path = str(old_p) + '_temp_rename'
